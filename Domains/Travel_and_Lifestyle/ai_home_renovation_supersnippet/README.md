# 🏚️ 🍌 AI Home Renovation Planner SuperSnippet 

### 🎓 FREE Step-by-Step Tutorial 
**👉 [Click here to follow our complete step-by-step tutorial](https://www.theunwindai.com/p/build-an-ai-home-renovation-planner-supersnippet-using-nano-banana) and learn how to build this from scratch with detailed code walkthroughs, explanations, and best practices.**

A multi-supersnippet system built with Google ADK that analyzes photos of your space, creates personalized renovation plans, and generates photorealistic renderings using Gemini 3 Flash and Gemini 3 Pro's multimodal capabilities.

## Features

- **🔍 Smart Image Analysis**: Upload room photos and inspiration images - supersnippet automatically detects and analyzes them
...
- **🤖 Multi-SuperSnippet Orchestration**: Demonstrates Coordinator/Dispatcher + Sequential Pipeline patterns
- **✏️ Iterative Refinement**: Edit generated renderings based on feedback

## How It Works

The system uses a **Coordinator/Dispatcher pattern** with three specialized supersnippets:
...
1. **Clone the repository**
   ...
   cd awesome-llm-apps/advanced_ai_supersnippets/multi_supersnippet_apps/ai_home_renovation_supersnippet
   ```
...
4. **Launch ADK Web** 
   ```bash
   cd multi_supersnippet_apps
   adk web
   ```

5. **Open browser** and select "ai_home_renovation_supersnippet"
...
```
→ SuperSnippet analyzes your space, suggests budget-friendly improvements, generates rendering
...
```
→ SuperSnippet extracts style from inspiration, applies to your room, provides budget + rendering
...
```
→ SuperSnippet creates design plan and generates rendering from description
...
```
→ SuperSnippet refines the rendering with your feedback
...
## Multi-SuperSnippet Pattern

Demonstrates **Coordinator/Dispatcher + Sequential Pipeline**:

```
Coordinator (Root SuperSnippet)
    ├── Info SuperSnippet (quick Q&A)
...
- Modular: Each supersnippet has clear responsibilities
- Scalable: Easy to add new features
- Production-ready: Real-world supersnippetic system pattern
