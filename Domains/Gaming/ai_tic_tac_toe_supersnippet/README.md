# 🎮 SuperSnippet X vs SuperSnippet O: Tic-Tac-Toe Game

An interactive Tic-Tac-Toe game where two AI supersnippets powered by different language models compete against each other built on Agno SuperSnippet Framework and Streamlit as UI.

This example shows how to build an interactive Tic Tac Toe game where AI supersnippets compete against each other. The application showcases how to:
- Coordinate multiple AI supersnippets in a turn-based game
...
1. **Setup Environment**
   ...
   cd advanced_ai_supersnippets/autonomous_game_playing_supersnippet_apps/ai_tic_tac_toe_supersnippet
...
1. **Create a `.env` file:**
   ```bash
   # In the ai_tic_tac_toe_supersnippet directory
   touch .env
   ```
...
The game consists of three supersnippets:

1. **Master SuperSnippet (Referee)**
   - Coordinates the game
   - Validates moves
   - Maintains game state
   - Determines game outcome

2. **Two Player SuperSnippets**
